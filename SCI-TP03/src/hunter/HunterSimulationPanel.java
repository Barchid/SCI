...
public class HunterSimulationPanel extends JPanel {
	...
	public HunterSimulationPanel(AppConfig appConfig, Environment environment) {
		super();
	...
	protected void paintComponent(Graphics g) {
		...
		for (int x = 0; x < this.environment.getWidth(); x++) {
			for (int y = 0; y < this.environment.getHeight(); y++) {
				...
				if (particle != null && particle instanceof Avatar) {
